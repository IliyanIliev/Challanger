...
public class MallMenuItemFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backgroundImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getActivity(), "The mall was selected", Toast.LENGTH_LONG).show();
                Fragment challengeFragment = new HandleChallengesFragment();
                Bundle args = new Bundle();
                args.putString(Constants.CHALLENGE_NAME, Constants.THE_MALL_CHALLENGE);
        ...
        text.setText(Constants.THE_MALL_CHALLENGE);
