...
public class CityMenuItemFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backgroundImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(getActivity(), "The city was selected", Toast.LENGTH_LONG).show();
                Fragment challengeFragment = new HandleChallengesFragment();
                Bundle args = new Bundle();
                args.putString(Constants.CHALLENGE_NAME, Constants.THE_CITY_CHALLENGE);
        ...
        //backgroundImageView.setBackgroundResource(R.drawable.city_image);

        TextView text=(TextView)root.findViewById(R.id.menu_item_name);
        text.setText(Constants.THE_CITY_CHALLENGE);
