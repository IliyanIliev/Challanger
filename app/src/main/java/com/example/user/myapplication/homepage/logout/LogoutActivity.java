...
public class LogoutActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
    ...
    private void loadLogoutFragment() {
        LogoutFragment fragment = new LogoutFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction()
                .add(R.id.logout_container, fragment)
                .commit();
    }
