...
public class ChallengesActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadChallengeTypesFragment();
    }

    private void loadChallengeTypesFragment() {
        ChallengeTypesFragment fragment = new ChallengeTypesFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction()
                .replace(R.id.challenges_container, fragment)
                .commit();
    }
